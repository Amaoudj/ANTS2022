...
class SmartAgent(AgentInterface):
    ...
    def __init__(self,conf,my_map,position,num_targets):
        ...
        self.special_path=[]
        #self.agent_I_gave_him_way= None
    ...
    def send_my_data(self,map:Map):
        ...
        data={"AgentID"        : self.id,
              ...
              #"agent_I_gave_him_way": self.agent_I_gave_him_way,
              "target"   : self.target
             }
    ...
    def handle_conflicts(self, map):
        ...
        if is_conflict:
            ...
            if successor is not None and successor["AgentID"] != self.id :
              #if self.agent_I_gave_him_way is not None and successor["AgentID"] != self.agent_I_gave_him_way:################successor["AgentID"] != successor["AgentID"]##
    ...
    def uncertainty(self,map,new_target,num_delay,add_new_OBS):
        ...
        if num_delay > 0 :
            if not self.im_done and not self.has_delayed :
    ...
    def next_step(self,map)->None:
        ...
        Deal with undesirable looping behavior and local minima
